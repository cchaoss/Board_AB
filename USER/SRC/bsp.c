...
static void DIDO_init(void)
{
	...
	GPIO_PinConfigure(KK_PORT,KK_PIN2,GPIO_OUT_PUSH_PULL,GPIO_MODE_OUT2MHZ);//中间继电器控制开关
	...
	GPIO_PinConfigure(DIP_SWITCH_PORT1,DIP_SWITCH_PIN1,GPIO_IN_PULL_UP,GPIO_MODE_INPUT);
	GPIO_PinConfigure(DIP_SWITCH_PORT2,DIP_SWITCH_PIN2,GPIO_IN_PULL_UP,GPIO_MODE_INPUT);
	GPIO_PinConfigure(DIP_SWITCH_PORT3,DIP_SWITCH_PIN3,GPIO_IN_PULL_UP,GPIO_MODE_INPUT);
	GPIO_PinConfigure(DIP_SWITCH_PORT4,DIP_SWITCH_PIN4,GPIO_IN_PULL_UP,GPIO_MODE_INPUT);//拨码开关输入
	...
	LED_ERR_OFF;LED_CHARGE_OFF;//充电/故障灯熄灭
	LED3_OFF;LED4_OFF;LED5_OFF;//失联灯5默认熄灭
